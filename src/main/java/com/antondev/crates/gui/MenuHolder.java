...
public final class MenuHolder implements InventoryHolder {
    public enum Kind {
        ...
        PLAYER_HALL, PLAYER_PREVIEW, PLAYER_QUANTITY, PLAYER_MASS_CONFIRM,
        PLAYER_SELECTIVE_CONFIRM, PLAYER_PENDING_REWARDS, PLAYER_KEYS, PLAYER_KEY_CRATES, PLAYER_HISTORY,
