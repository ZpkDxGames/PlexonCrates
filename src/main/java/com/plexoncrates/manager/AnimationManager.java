...
public final class AnimationManager {
    ...
    private void fountain(Location center){World world=center.getWorld();if(world==null)return;world.spawnParticle(Particle.ENCHANT,center.clone().add(0,1.0D,0),4,0.35D,0.6D,0.35D,0.05D);if(((int)(phase*10))%3==0)world.spawnParticle(Particle.END_ROD,center.clone().add(0,1.25D,0),1,0.05D,0.2D,0.05D,0.01D);}
